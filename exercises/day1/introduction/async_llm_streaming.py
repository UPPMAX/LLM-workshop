# Original: from vLLM Github repository
# SPDX-License-Identifier: Apache-2.0
# SPDX-FileCopyrightText: Copyright contributors to the vLLM project

# Adapted for NAISS LLM workshop
"""
...
async def main():
    ...
    engine_args = AsyncEngineArgs(
        model="/mimer/NOBACKUP/Datasets/LLM/huggingface/hub/models--unsloth--Llama-3.2-3B-Instruct/snapshots/c22b3d3ff8b9c928eeeb518261daf345aa121dc3/",
